	...
	,occur: function(){
		var inputSearch = this.dat
			...
			,buttS =[
				...
				//,['S','site:yoursite.com',lang?'искать по yoursite.com':lNull?'':'search in yoursite.com'] //write your site name and uncomment
		...
		$e({el:document.querySelector('.gb_i'),cs:{zIndex:'987'}} );
	}
});

})('en'); //remove for no hints; write 'en' for English hints, 'ru' for Russian
